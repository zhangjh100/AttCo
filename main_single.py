...
if __name__=="__main__":
    ...
    for fold in range(5):
        ...
        parser.add_argument('--path_image', type=str, default="/datapool/home/ph_teacher1/zhangjh/datasets/multimodal/BraTS2020/MICCAI_BraTS2020_TrainingData",
                            help='')
        parser.add_argument('--pretrained', type=str, default=None, 
                            help='')  
        parser.add_argument('--modelname', type=str, default="WaveCo",
        ...
        if arg.modelname == "WaveCo":
            ...
            model = net.WaveCo3(inChannel=1, outChannel=4, baseChannel=24)
        elif arg.modelname == "WaveCo4":
            import models.WaveCo4_BraTS as net
            model = net.WaveCo4(inChannel=1, outChannel=4, baseChannel=24)
        ...
        for epoch in range(arg.epochs):
            ...
            if min_loss > loss_val:
                ...
                filename = "/datapool/home/ph_teacher1/zhangjh/AttCo/checkpoint/{}/{}/Fold_{}_bs_{}_TC_{}_ED_{}_ET_{}_WT_{}.pt".format(arg.dataname, arg.modelname, fold, arg.train_batch_size, dice_val[0], dice_val[1], dice_val[2], dice_val[3])
            ...
            log_data_frame.to_csv("/datapool/home/ph_teacher1/zhangjh/AttCo/checkpoint/{}/{}/log_train_BraTS2020_fold_{}_bs_{}.csv".format(arg.dataname, arg.modelname, fold, arg.train_batch_size), index=False)
